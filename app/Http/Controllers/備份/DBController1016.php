...
///// // }
    ...
    function add_question(Request $req) {
        ...
        if($req->Choose =="model"){
            ...
            $new_model_url = "http://134.208.3.123/AR_English_Learning_DEMO8_4test/storage/app/public/model/".$newmodel_Name;
            $youtube_url = null;
        }
    ...
    function reupload_question(Request $req){
        ...
        $vuforiaClient = new VuforiaController;
        $vuforiaMetaData = "http://134.208.3.123/AR_English_Learning_DEMO8_4test/storage/app/".$jsonName;
        $vuforiaTargetData = $vuforiaClient->addTarget(
            'http://134.208.3.123/AR_English_Learning_DEMO8_4test/storage/app/public/image',
            $newName,
            $vuforiaMetaData
        );
        $vuforia_id =$vuforiaTargetData->target_id;
